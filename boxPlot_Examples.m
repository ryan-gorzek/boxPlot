...
figure('Position', [100, 100, 300, 500]);
rng(2);
data2_vec = [randn(80, 1) * 0.8 + 5; randn(100, 1) * 1.2 + 7; randn(20, 1) * 0.9 + 6];
labels2 = [ones(80, 1); 2*ones(100, 1); 3*ones(20, 1)];
...
title('Unequal Groups with Data Points', 'FontSize', 18);
...
% Demonstrates horizontal orientation for boxplots

figure('Position', [100, 100, 400, 500]);
rng(11);

% Simulate experiment with multiple conditions
data11 = [randn(40, 1) * 1.5 + 8,  randn(40, 1) * 1.8 + 12, randn(40, 1) * 1.6 + 15, ...
          randn(40, 1) * 1.7 + 10, randn(40, 1) * 1.9 + 14, randn(40, 1) * 1.8 + 18];
...
boxPlot(data11, ...
    ...
    'medianWidth', 2, ...
    'plotLegend', true, ...
    'lgdLabels', {'Control', 'Drug A', 'Drug B'}, ...
    'lgdColors', {[0.7, 0.7, 0.7], [0.5, 0.7, 0.9], [0.9, 0.6, 0.5]}, ...
    'lgdLocation', 'southeast', ...
    'lgdBox', 'on');

title('Horizontal: Treatment by Dosage Level', 'FontSize', 18);
xlabel('Response (units)', 'FontSize', 14);
ylabel('Dosage', 'FontSize', 14);
...
data10 = [randn(60, 1) * 1.5 + 10, randn(60, 1) * 1.8 + 15, ...
...
ylabel('Concentration (µM)', 'FontSize', 14);
